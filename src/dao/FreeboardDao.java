...
public class FreeboardDao {
	...
	public Freeboard getDetail(int board_id){
		SqlSession mapper = factory.openSession();
		Freeboard vo = mapper.selectOne("freeboard.detail",board_id);
		mapper.close();
		return vo;
	}
	...
	public void readcountUp(int board_id) {
		SqlSession mapper = factory.openSession();
		mapper.update("readcountUp", board_id);
		mapper.commit();
		mapper.close();
	}
